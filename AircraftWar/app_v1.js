...
//		if(e.offsetX<imgsHero[0].width/2){
//			hero.x=0;
//		}else if(e.offsetX>canvas.width-imgsHero[0].width){
//			hero.x=canvas.width-imgsHero[0].width;
//		}else{
//			hero.x=e.offsetX-imgsHero[0].width/2
//		}
//		if(e.offsetY<imgsHero[0].height/2){
//			hero.y=0;
//		}else if(e.offsetY>canvas.height-imgsHero[0].height){
//			hero.y=canvas.height-imgsHero[0].height;
//		}else{
